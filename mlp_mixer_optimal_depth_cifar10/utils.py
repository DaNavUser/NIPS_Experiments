...
def results_loader(ids_set=None):
    ...
    minimax_epoch = 40  # sorted(max_epochs)[5]
    ...
    return runs_dct, sorted_combs_by_acc, minimax_epoch
...
def results_table_printer():
    ids_set = get_ids_set()
    runs_dct, sorted_combs,epochs = results_loader(ids_set)

    graph_plotter(runs_dct, epochs)
